...
$$
\begin{aligned}
Moment_x = \beta_0 + \beta_1*St + \sum_{i=2}^{4}\beta_i*Re_i + \sum_{j=5}^{7}\beta_j*Fr_j \\ + \sum_{k=8}^{10}\beta_k *\text{(all two-way interactions between St, Re and Fr)} \\
