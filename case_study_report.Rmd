...
train_noinf$Fr.logit <- inv.logit(train_noinf$Fr)
```
...
```{r}
library(splines)
fit <- smooth.spline(iris$Sepal.Width, iris$Sepal.Length, df = 10)
fit2 <- smooth.spline(iris$Sepal.Width, iris$Sepal.Length, cv = TRUE)
fit2$df
lines(fit, col = "red", lwd = 2)
lines(fit2, col = "blue", lwd = 2)
legend("topright", legend = c("10 DF", "5.3 DF"), col = c("red", "blue"),
       lty = 1, lwd = 2, cex = 0.8)
```
